...
## Docker web control app

The Docker setup runs only the browser control app. Keep the normal bridge/TUI running on the host, then start the web UI container:

```bash
dexyd --tui              # or use the dexyd.service host bridge
